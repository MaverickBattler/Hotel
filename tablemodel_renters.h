#ifndef TABLEMODEL_RENTERS_H
#define TABLEMODEL_RENTERS_H
...
class TableModel_renters : public QAbstractTableModel
{
    Q_OBJECT
    friend MainWindow;
public:
    TableModel_renters(QObject * parent);
