#ifndef TABLEMODEL_REPORT_2_H
#define TABLEMODEL_REPORT_2_H
...
class TableModel_report_2 : public QAbstractTableModel
{
    Q_OBJECT
    friend MainWindow;
...
public:
    TableModel_report_2(QObject * parent);
